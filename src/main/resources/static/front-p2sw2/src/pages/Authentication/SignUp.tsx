...
const SignUp: React.FC = () => {
  const { formData, handleSubmit, handleInputChange } = useSignUpForm();


  return (
      <>
        <div className="rounded-sm border w-full h-full border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
